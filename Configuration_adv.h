...
#if ENABLED(CR10S) //COVID19 - Default value is (SIDEWINDER_X1). It is probably a printer with dual Z drivers out of the box. I'm piecemealing this code to think it does. See Ramps_CR10S header to see those changes.
...
#define TEMP_SENSOR_AD595_GAIN   1.0
  ...
  //#define ENCODER_RATE_MULTIPLIER //COVID19 - Commented this out to remove click wheel feed rate change 
...
//#define QUICK_HOME //COVID19 - Commented this out to avoid confusion with custom homing command

#define COVID_HOME //COVID19 - Added custom Covid Home function to home Y & Z together
...
#if ENABLED(CR10S)//COVID19 - Changed to CR10S. Default: WANHAO_I3_PLUS
  #define EMERGENCY_PARSER
  //#define ACTION_ON_KILL "poweroff" //COVID19 - Not really sure what this is, but we probably don't need it.
#endif
