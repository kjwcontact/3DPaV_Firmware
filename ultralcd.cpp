...
uint16_t max_display_update_time = 0;
  ...
  void lcd_ventilator_menu(); //COVID19 - Added the ventilator settings menu
  void loopender_funct(); //COVID19 - Added function to get out of the ventilator loop
...
void lcd_quick_feedback(const bool clear_buttons) {
  ...
  void lcd_main_menu() {
    ...
    MENU_ITEM(submenu, MSG_VENTILATOR, lcd_ventilator_menu);
  ...
  /**
   * //COVID19 - THIS IS THE START OF THE VENTILATOR MENU
   * "ventilator" submenu
   *
   */
 ...
 void halt_ventilator() {
    loopender_funct();
    enqueue_and_echo_commands_P(PSTR("M18"));
    lcd_goto_screen(lcd_ventilator_menu);
   }
   
 void lcd_yes() {
    START_MENU();
    MENU_ITEM(submenu, MSG_ARE_YOU_REALLY_SURE, lcd_yes);
    MENU_ITEM(function, MSG_YES, halt_ventilator);
    MENU_ITEM(submenu, MSG_NO, lcd_ventilator_menu);
    END_MENU();
   }

 void lcd_initialize_ventilator() {
    enqueue_and_echo_commands_P(PSTR("M17"));
    enqueue_and_echo_commands_P(PSTR("M502"));
    enqueue_and_echo_commands_P(PSTR("M500"));
    enqueue_and_echo_commands_P(PSTR("G28 Y Z"));
   }

  void lcd_halt_ventilator() {
    START_MENU();
    MENU_ITEM(submenu, MSG_ARE_YOU_SURE, lcd_halt_ventilator);
    MENU_ITEM(submenu, MSG_YES, lcd_yes);
    MENU_ITEM(submenu, MSG_NO, lcd_ventilator_menu);
    END_MENU();
   }

  
  void lcd_invalid_combo() {
    int waste = 1;
   } 
   
  void lcd_one_to_one() {
    if (covid_volume == 200 && covid_bpm == 4) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F257 P257 Z10 Y30"));
    } else if (covid_volume == 250 && covid_bpm == 4) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F295 P295 Z11.5 Y34.5"));  
    } else if (covid_volume == 300 && covid_bpm == 4) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F360 P360 Z14 Y42"));
    } else if (covid_volume == 350 && covid_bpm == 4) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F385 P385 Z15 Y45"));
    } else if (covid_volume == 400 && covid_bpm == 4) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F437 P437 Z17 Y51"));
    } else if (covid_volume == 450 && covid_bpm == 4) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F463 P463 Z18 Y54"));
    } else if (covid_volume == 500 && covid_bpm == 4) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F501 P501 Z19.5 Y58.5"));
    } else if (covid_volume == 550 && covid_bpm == 4) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F553 P553 Z21.5 Y64.5"));
    } else if (covid_volume == 600 && covid_bpm == 4) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F591.5 P591.5 Z23 Y69"));
    } else if (covid_volume == 650 && covid_bpm == 4) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F630 P630 Z24.5 Y73.5"));
    } else if (covid_volume == 700 && covid_bpm == 4) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F668.5 P668.5 Z26 Y78"));
    } else if (covid_volume == 750 && covid_bpm == 4) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F707.5 P707.5 Z27.5 Y82.5"));
    } else if (covid_volume == 800 && covid_bpm == 4) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F759.5 P759.5 Z29.5 Y88.5"));
    } else if (covid_volume == 850 && covid_bpm == 4) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F798 P798 Z31 Y93"));
    } else if (covid_volume == 900 && covid_bpm == 4) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F850 P850 Z33 Y99"));
    } else if (covid_volume == 950 && covid_bpm == 4) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F876 P876 Z34 Y102"));
    } else if (covid_volume == 1000 && covid_bpm == 4) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F940.5 P940.5 Z36.5 Y109.5"));
    } 

    
      else if (covid_volume == 200 && covid_bpm == 8) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F522 P522 Z10 Y30"));
    } else if (covid_volume == 250 && covid_bpm == 8) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F601 P601 Z11.5 Y34.5"));  
    } else if (covid_volume == 300 && covid_bpm == 8) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F733 P733 Z14 Y42"));
    } else if (covid_volume == 350 && covid_bpm == 8) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F785 P785 Z15 Y45"));
    } else if (covid_volume == 400 && covid_bpm == 8) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F891 P891 Z17 Y51"));
    } else if (covid_volume == 450 && covid_bpm == 8) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F944 P944 Z18 Y54"));
    } else if (covid_volume == 500 && covid_bpm == 8) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F1026 P1026 Z19.5 Y58.5"));
    } else if (covid_volume == 550 && covid_bpm == 8) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F1130 P1130 Z21.5 Y64.5"));
    } else if (covid_volume == 600 && covid_bpm == 8) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F1212 P1212 Z23 Y69"));
    } else if (covid_volume == 650 && covid_bpm == 8) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F1292 P1292 Z24.5 Y73.5"));
    } else if (covid_volume == 700 && covid_bpm == 8) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F1370 P1370 Z26 Y78"));
    } else if (covid_volume == 750 && covid_bpm == 8) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F1452 P1452 Z27.5 Y82.5"));
    } else if (covid_volume == 800 && covid_bpm == 8) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F1557 P1557 Z29.5 Y88.5"));
    } else if (covid_volume == 850 && covid_bpm == 8) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F1640 P1640 Z31 Y93"));
    } else if (covid_volume == 900 && covid_bpm == 8) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F1744 P1744 Z33 Y99"));
    } else if (covid_volume == 950 && covid_bpm == 8) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F1799 P1799 Z34 Y102"));
    } else if (covid_volume == 1000 && covid_bpm == 8) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F1935 P1935 Z36.5 Y109.5"));
    }
    
    

      else if (covid_volume == 200 && covid_bpm == 12) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F799.5 P800 Z10 Y30"));
    } else if (covid_volume == 250 && covid_bpm == 12) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F921 P921 Z11.5 Y34.5"));
    } else if (covid_volume == 300 && covid_bpm == 12) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F1127 P1127 Z14 Y42"));
    } else if (covid_volume == 350 && covid_bpm == 12) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F1207 P1207 Z15 Y45"));
    } else if (covid_volume == 400 && covid_bpm == 12) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F1372 P1372 Z17 Y51"));
    } else if (covid_volume == 450 && covid_bpm == 12) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F1455 P1455 Z18 Y54"));
    } else if (covid_volume == 500 && covid_bpm == 12) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F1578 P1578 Z19.5 Y58.5"));
    } else if (covid_volume == 550 && covid_bpm == 12) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F1742 P1742 Z21.5 Y64.5"));
    } else if (covid_volume == 600 && covid_bpm == 12) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F1868 P1868 Z23 Y69"));
    } else if (covid_volume == 650 && covid_bpm == 12) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F1997 P1997 Z24.5 Y73.5"));
    } else if (covid_volume == 700 && covid_bpm == 12) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F2124 P2124 Z26 Y78"));
    } else if (covid_volume == 750 && covid_bpm == 12) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F2249 P2249 Z27.5 Y82.5"));
    } else if (covid_volume == 800 && covid_bpm == 12) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F2419 P2419 Z29.5 Y88.5"));
    } else if (covid_volume == 850 && covid_bpm == 12) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F2545 P2545 Z31 Y93"));
    } else if (covid_volume == 900 && covid_bpm == 12) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F2716.6 P2717 Z33 Y99"));
    } else if (covid_volume == 950 && covid_bpm == 12) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F2800.2 P2800 Z34 Y102"));
    } else if (covid_volume == 1000 && covid_bpm == 12) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F3013.5 P3013 Z36.5 Y109.5"));
    }
    
    

      else if (covid_volume == 200 && covid_bpm == 16) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F1092 P1092 Z10 Y30"));
    } else if (covid_volume == 250 && covid_bpm == 16) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F1260 P1260 Z11.5 Y34.5"));  
    } else if (covid_volume == 300 && covid_bpm == 16) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F1542 P1542 Z14 Y42"));
    } else if (covid_volume == 350 && covid_bpm == 16) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F1659 P1659 Z15 Y45"));
    } else if (covid_volume == 400 && covid_bpm == 16) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F1888 P1888 Z17 Y51"));
    } else if (covid_volume == 450 && covid_bpm == 16) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F2005 P2005 Z18 Y54"));
    } else if (covid_volume == 500 && covid_bpm == 16) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F2178 P2178 Z19.5 Y58.5"));
    } else if (covid_volume == 550 && covid_bpm == 16) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F2412 P2412 Z21.5 Y64.5"));
    } else if (covid_volume == 600 && covid_bpm == 16) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F2580 P2580 Z23 Y69"));
    } else if (covid_volume == 650 && covid_bpm == 16) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F2765 P2765 Z24.5 Y73.5"));
    } else if (covid_volume == 700 && covid_bpm == 16) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F2930 P2930 Z26 Y78"));
    } else if (covid_volume == 750 && covid_bpm == 16) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F3125 P3125 Z27.5 Y82.5"));
    } else if (covid_volume == 800 && covid_bpm == 16) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F3375 P3375 Z29.5 Y88.5"));
    } else if (covid_volume == 850 && covid_bpm == 16) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F3560 P3560 Z31 Y93"));
    } else if (covid_volume == 900 && covid_bpm == 16) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F3818 P3818 Z33 Y99"));
    } 
    


      else if (covid_volume == 200 && covid_bpm == 20) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F1406 P1406 Z10 Y30"));
    } else if (covid_volume == 250 && covid_bpm == 20) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F1623 P1623 Z11.5 Y34.5"));
    } else if (covid_volume == 300 && covid_bpm == 20) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F1993 P1993 Z14 Y42"));
    } else if (covid_volume == 350 && covid_bpm == 20) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F2144 P2144 Z15 Y45"));
    } else if (covid_volume == 400 && covid_bpm == 20) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F2444 P2444 Z17 Y51"));
    } else if (covid_volume == 450 && covid_bpm == 20) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F2596 P2596 Z18 Y54"));
    } else if (covid_volume == 500 && covid_bpm == 20) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F2833 P2833 Z19.5 Y58.5"));
    } else if (covid_volume == 550 && covid_bpm == 20) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F3160 P3160 Z21.5 Y64.5"));
    } else if (covid_volume == 600 && covid_bpm == 20) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F3400 P3400 Z23 Y69"));
    } else if (covid_volume == 650 && covid_bpm == 20) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F3630 P3630 Z24.5 Y73.5"));
    } else if (covid_volume == 700 && covid_bpm == 20) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F3900 P3900 Z26 Y78"));
    } else if (covid_volume == 750 && covid_bpm == 20) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F4110 P4110 Z27.5 Y82.5"));
    }
     
    

      else if (covid_volume == 200 && covid_bpm == 24) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F1737.5 P1738 Z10 Y30"));
    } else if (covid_volume == 250 && covid_bpm == 24) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F2018 P2018 Z11.5 Y34.5"));
    } else if (covid_volume == 300 && covid_bpm == 24) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F2486 P2486 Z14 Y42"));
    } else if (covid_volume == 350 && covid_bpm == 24) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F2690 P2690 Z15 Y45"));
    } else if (covid_volume == 400 && covid_bpm == 24) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F3082 P3082 Z17 Y51"));
    } else if (covid_volume == 450 && covid_bpm == 24) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F3277 P3277 Z18 Y54"));
    } else if (covid_volume == 500 && covid_bpm == 24) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F3589 P3589 Z19.5 Y58.5"));
    } else if (covid_volume == 550 && covid_bpm == 24) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F4008 P4008 Z21.5 Y64.5"));
    } else if (covid_volume == 600 && covid_bpm == 24) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F4346 P4346 Z23 Y69"));
    }
     
    

      else if (covid_volume == 200 && covid_bpm == 28) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F2107 P2107 Z10 Y30"));
    } else if (covid_volume == 250 && covid_bpm == 28) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F2448 P2448 Z11.5 Y34.5"));
    } else if (covid_volume == 300 && covid_bpm == 28) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F3050 P3050 Z14 Y42"));
    } else if (covid_volume == 350 && covid_bpm == 28) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F3296 P3296 Z15 Y45"));
    } else if (covid_volume == 400 && covid_bpm == 28) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F3826 P3826 Z17 Y51"));
    } else if (covid_volume == 450 && covid_bpm == 28) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F4069 P4069 Z18 Y54"));
    } else if (covid_volume == 500 && covid_bpm == 28) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F4508 P4508 Z19.5 Y58.5"));
    }
         


      else if (covid_volume == 200 && covid_bpm == 32) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F2514 P2514 Z10 Y30"));
    } else if (covid_volume == 250 && covid_bpm == 32) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F2930 P2930 Z11.5 Y34.5"));
    } else if (covid_volume == 300 && covid_bpm == 32) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F3721 P3721 Z14 Y42"));
    } else if (covid_volume == 350 && covid_bpm == 32) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F4030 P4030 Z15 Y45"));
    } else if (covid_volume == 400 && covid_bpm == 32) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F4718 P4718 Z17 Y51"));
    } else if (covid_volume == 450 && covid_bpm == 32) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F5086 P5086 Z18 Y54"));
    }
        


      else if (covid_volume == 200 && covid_bpm == 36) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F2980 P2980 Z10 Y30"));
    } else if (covid_volume == 250 && covid_bpm == 36) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F3537 P3537 Z11.5 Y34.5"));
    } else if (covid_volume == 300 && covid_bpm == 36) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F4553 P4553 Z14 Y42"));
    } else if (covid_volume == 350 && covid_bpm == 36) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F4978 P4978 Z15 Y45"));
    } else if (covid_volume == 400 && covid_bpm == 36) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F6033 P6033 Z17 Y51"));
    }
 ...
 void lcd_one_to_two() {    
    if (covid_volume == 200 && covid_bpm == 4) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F388.1 P192 Z10 Y30"));
    } else if (covid_volume == 250 && covid_bpm == 4) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F446.8 P220 Z11.5 Y34.5"));  
    } else if (covid_volume == 300 && covid_bpm == 4) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F544.1 P268 Z14 Y42"));
    } else if (covid_volume == 350 && covid_bpm == 4) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F583.4 P287 Z15 Y45"));
    } else if (covid_volume == 400 && covid_bpm == 4) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F661 P326 Z17 Y51"));
    } else if (covid_volume == 450 && covid_bpm == 4) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F700.9 P345 Z18 Y54"));
    } else if (covid_volume == 500 && covid_bpm == 4) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F760 P374 Z19.5 Y58.5"));
    } else if (covid_volume == 550 && covid_bpm == 4) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F837.7 P413 Z21.5 Y64.5"));
    } else if (covid_volume == 600 && covid_bpm == 4) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F896.5 P442 Z23 Y69"));
    } else if (covid_volume == 650 && covid_bpm == 4) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F955 P470 Z24.5 Y73.5"));
    } else if (covid_volume == 700 && covid_bpm == 4) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F1016.5 P499 Z26 Y78"));
    } else if (covid_volume == 750 && covid_bpm == 4) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F1075 P528 Z27.5 Y82.5"));
    } else if (covid_volume == 800 && covid_bpm == 4) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F1154 P566 Z29.5 Y88.5"));
    } else if (covid_volume == 850 && covid_bpm == 4) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F1213 P596 Z31 Y93"));
    } else if (covid_volume == 900 && covid_bpm == 4) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F1294 P634 Z33 Y99"));
    } else if (covid_volume == 950 && covid_bpm == 4) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F1331.5 P653 Z34 Y102"));
    } else if (covid_volume == 1000 && covid_bpm == 4) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F1431 P701 Z36.5 Y109.5"));
    } 


      else if (covid_volume == 200 && covid_bpm == 8) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F799.5 P388 Z10 Y30"));
    } else if (covid_volume == 250 && covid_bpm == 8) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F921 P447 Z11.5 Y34.5"));   
    } else if (covid_volume == 300 && covid_bpm == 8) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F1127 P545 Z14 Y42"));
    } else if (covid_volume == 350 && covid_bpm == 8) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F1207 P583.4 Z15 Y45"));
    } else if (covid_volume == 400 && covid_bpm == 8) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F1372 P661 Z17 Y51"));
    } else if (covid_volume == 450 && covid_bpm == 8) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F1455 P700.9 Z18 Y54"));
    } else if (covid_volume == 500 && covid_bpm == 8) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F1578 P759 Z19.5 Y58.5"));
    } else if (covid_volume == 550 && covid_bpm == 8) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F1742 P837 Z21.5 Y64.5"));
    } else if (covid_volume == 600 && covid_bpm == 8) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F1868 P897 Z23 Y69"));
    } else if (covid_volume == 650 && covid_bpm == 8) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F1997 P955 Z24.5 Y73.5"));
    } else if (covid_volume == 700 && covid_bpm == 8) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F2124 P1016 Z26 Y78"));
    } else if (covid_volume == 750 && covid_bpm == 8) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F2249 P1075 Z27.5 Y82.5"));
    } else if (covid_volume == 800 && covid_bpm == 8) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F2419 P1154 Z29.5 Y88.5"));
    } else if (covid_volume == 850 && covid_bpm == 8) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F2545 P1212 Z31 Y93"));
    } else if (covid_volume == 900 && covid_bpm == 8) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F2716.6 P1294 Z33 Y99"));
    } else if (covid_volume == 950 && covid_bpm == 8) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F2800.2 P1331 Z34 Y102"));
    } else if (covid_volume == 1000 && covid_bpm == 8) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F3013.5 P1432 Z36.5 Y109.5"));
    }
    
      
      else if (covid_volume == 200 && covid_bpm == 12) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F1243 P591 Z10 Y30"));
    } else if (covid_volume == 250 && covid_bpm == 12) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F1439 P679 Z11.5 Y34.5"));  
    } else if (covid_volume == 300 && covid_bpm == 12) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F1760 P830 Z14 Y42"));
    } else if (covid_volume == 350 && covid_bpm == 12) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F1900 P888 Z15 Y45"));
    } else if (covid_volume == 400 && covid_bpm == 12) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F2162 P1011 Z17 Y51"));
    } else if (covid_volume == 450 && covid_bpm == 12) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F2295 P1072 Z18 Y54"));
    } else if (covid_volume == 500 && covid_bpm == 12) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F2495 P1162 Z19.5 Y58.5"));
    } else if (covid_volume == 550 && covid_bpm == 12) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F2775 P1280 Z21.5 Y64.5"));
    } else if (covid_volume == 600 && covid_bpm == 12) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F2970 P1372 Z23 Y69"));
    } else if (covid_volume == 650 && covid_bpm == 12) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F3192 P1463 Z24.5 Y73.5"));
    } else if (covid_volume == 700 && covid_bpm == 12) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F3400 P1553 Z26 Y78"));
    } else if (covid_volume == 750 && covid_bpm == 12) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F3617 P1648 Z27.5 Y82.5"));
    } else if (covid_volume == 800 && covid_bpm == 12) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F3903 P1768 Z29.5 Y88.5"));
    } else if (covid_volume == 850 && covid_bpm == 12) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F4105 P1858 Z31 Y93"));
    } else if (covid_volume == 900 && covid_bpm == 12) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F4408 P1983 Z33 Y99"));
    } else if (covid_volume == 950 && covid_bpm == 12) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F4569 P2044 Z34 Y102"));
    } else if (covid_volume == 1000 && covid_bpm == 12) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F4907 P2197 Z36.5 Y109.5"));
    }


      else if (covid_volume == 200 && covid_bpm == 16) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F1737.5 P799 Z10 Y30"));
    } else if (covid_volume == 250 && covid_bpm == 16) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F2018 P921 Z11.5 Y34.5"));
    } else if (covid_volume == 300 && covid_bpm == 16) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F2486 P1127 Z14 Y42"));
    } else if (covid_volume == 350 && covid_bpm == 16) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F2690 P1207 Z15 Y45"));
    } else if (covid_volume == 400 && covid_bpm == 16) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F3082 P1372 Z17 Y51"));
    } else if (covid_volume == 450 && covid_bpm == 16) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F3277 P1455 Z18 Y54"));
    } else if (covid_volume == 500 && covid_bpm == 16) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F3589 P1577 Z19.5 Y58.5"));
    } else if (covid_volume == 550 && covid_bpm == 16) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F4008 P1744 Z21.5 Y64.5"));
    } else if (covid_volume == 600 && covid_bpm == 16) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F4346 P1868 Z23 Y69"));
    } else if (covid_volume == 650 && covid_bpm == 16) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F4677.5 P1997 Z24.5 Y73.5"));
    } else if (covid_volume == 700 && covid_bpm == 16) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F5000 P2124 Z26 Y78"));
    } else if (covid_volume == 750 && covid_bpm == 16) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F5394 P2246 Z27.5 Y82.5"));
    } else if (covid_volume == 800 && covid_bpm == 16) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F5844 P2419 Z29.5 Y88.5"));
    } else if (covid_volume == 850 && covid_bpm == 16) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F6211 P2545 Z31 Y93"));
    } else if (covid_volume == 900 && covid_bpm == 16) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F6740 P2717 Z33 Y99"));
    }
    
      else if (covid_volume == 200 && covid_bpm == 20) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F2296 P1018 Z10 Y30"));
    } else if (covid_volume == 250 && covid_bpm == 20) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F2691 P1177 Z11.5 Y34.5"));
    } else if (covid_volume == 300 && covid_bpm == 20) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F3366 P1437 Z14 Y42"));
    } else if (covid_volume == 350 && covid_bpm == 20) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F3644.5 P1540 Z15 Y45"));
    } else if (covid_volume == 400 && covid_bpm == 20) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F4252 P1755 Z17 Y51"));
    } else if (covid_volume == 450 && covid_bpm == 20) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F4553 P1860 Z18 Y54"));
    } else if (covid_volume == 500 && covid_bpm == 20) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F5050 P2025 Z19.5 Y58.5"));
    } else if (covid_volume == 550 && covid_bpm == 20) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F5750 P2237 Z21.5 Y64.5"));
    } else if (covid_volume == 600 && covid_bpm == 20) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F6300 P2405 Z23 Y69"));
    } else if (covid_volume == 650 && covid_bpm == 20) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F6950 P2563 Z24.5 Y73.5"));
    } else if (covid_volume == 700 && covid_bpm == 20) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F7600 P2731 Z26 Y78"));
    } else if (covid_volume == 750 && covid_bpm == 20) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F8295 P2895 Z27.5 Y82.5"));
    }


      else if (covid_volume == 200 && covid_bpm == 24) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F2980 P1243 Z10 Y30"));
    } else if (covid_volume == 250 && covid_bpm == 24) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F3537 P1439 Z11.5 Y34.5"));
    } else if (covid_volume == 300 && covid_bpm == 24) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F4553 P1760 Z14 Y42"));
    } else if (covid_volume == 350 && covid_bpm == 24) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F4978 P1896 Z15 Y45"));
    } else if (covid_volume == 400 && covid_bpm == 24) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F6033 P2162 Z17 Y51"));
    } else if (covid_volume == 450 && covid_bpm == 24) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F6651.5 P2292 Z18 Y54"));
    } else if (covid_volume == 500 && covid_bpm == 24) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F7740 P2495 Z19.5 Y58.5"));
    } else if (covid_volume == 550 && covid_bpm == 24) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F9950 P2765 Z21.5 Y64.5"));
    } 
    

      else if (covid_volume == 200 && covid_bpm == 28) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F3907 P1481 Z10 Y30"));
    } else if (covid_volume == 250 && covid_bpm == 28) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F4755 P1718 Z11.5 Y34.5"));
    } else if (covid_volume == 300 && covid_bpm == 28) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F6661 P2117 Z14 Y42"));
    } else if (covid_volume == 350 && covid_bpm == 28) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F8150 P2270 Z15 Y45"));
    } 


      else if (covid_volume == 200 && covid_bpm == 32) {
      loopender_funct();
      enqueue_and_echo_commands_P(PSTR("M555 F5484.5 P1737 Z10 Y30"));
    } 
      lcd_goto_screen(lcd_ventilator_menu);
    } 
 ...
 void lcd_four_bpm() {
    ...
    START_MENU();
    if (covid_volume == 200) {
      MENU_BACK(MSG_TWO_HUNDRED_ML);
      MENU_ITEM(function, MSG_IE_ONE_TO_ONE, lcd_one_to_one);
      MENU_ITEM(function, MSG_IE_ONE_TO_TWO, lcd_one_to_two);
    } else if (covid_volume == 250){
      MENU_BACK(MSG_TWO_FIFTY_ML);
      MENU_ITEM(function, MSG_IE_ONE_TO_ONE, lcd_one_to_one);
      MENU_ITEM(function, MSG_IE_ONE_TO_TWO, lcd_one_to_two);    
    } else if (covid_volume == 300) {
      MENU_BACK(MSG_THREE_HUNDRED_ML);
      MENU_ITEM(function, MSG_IE_ONE_TO_ONE, lcd_one_to_one);
      MENU_ITEM(function, MSG_IE_ONE_TO_TWO, lcd_one_to_two);
    } else if (covid_volume == 350){
      MENU_BACK(MSG_THREE_FIFTY_ML);
      MENU_ITEM(function, MSG_IE_ONE_TO_ONE, lcd_one_to_one);
      MENU_ITEM(function, MSG_IE_ONE_TO_TWO, lcd_one_to_two);    
    } else if (covid_volume == 400){
      MENU_BACK(MSG_FOUR_HUNDRED_ML);
      MENU_ITEM(function, MSG_IE_ONE_TO_ONE, lcd_one_to_one);
      MENU_ITEM(function, MSG_IE_ONE_TO_TWO, lcd_one_to_two);     
    } else if (covid_volume == 450){
      MENU_BACK(MSG_FOUR_FIFTY_ML);
      MENU_ITEM(function, MSG_IE_ONE_TO_ONE, lcd_one_to_one);
      MENU_ITEM(function, MSG_IE_ONE_TO_TWO, lcd_one_to_two);     
    } else if (covid_volume == 500){
      MENU_BACK(MSG_FIVE_HUNDRED_ML);
      MENU_ITEM(function, MSG_IE_ONE_TO_ONE, lcd_one_to_one);
      MENU_ITEM(function, MSG_IE_ONE_TO_TWO, lcd_one_to_two); 
    } else if (covid_volume == 550){
      MENU_BACK(MSG_FIVE_FIFTY_ML);
      MENU_ITEM(function, MSG_IE_ONE_TO_ONE, lcd_one_to_one);
      MENU_ITEM(function, MSG_IE_ONE_TO_TWO, lcd_one_to_two);     
    } else if (covid_volume == 600){
      MENU_BACK(MSG_SIX_HUNDRED_ML);
      MENU_ITEM(function, MSG_IE_ONE_TO_ONE, lcd_one_to_one);
      MENU_ITEM(function, MSG_IE_ONE_TO_TWO, lcd_one_to_two); 
    } else if (covid_volume == 650){
      MENU_BACK(MSG_SIX_FIFTY_ML);
      MENU_ITEM(function, MSG_IE_ONE_TO_ONE, lcd_one_to_one);
      MENU_ITEM(function, MSG_IE_ONE_TO_TWO, lcd_one_to_two);     
    } else if (covid_volume == 700){
      MENU_BACK(MSG_SEVEN_HUNDRED_ML);
      MENU_ITEM(function, MSG_IE_ONE_TO_ONE, lcd_one_to_one);
      MENU_ITEM(function, MSG_IE_ONE_TO_TWO, lcd_one_to_two); 
    } else if (covid_volume == 750){
      MENU_BACK(MSG_SEVEN_FIFTY_ML);
      MENU_ITEM(function, MSG_IE_ONE_TO_ONE, lcd_one_to_one);
      MENU_ITEM(function, MSG_IE_ONE_TO_TWO, lcd_one_to_two);     
    } else if (covid_volume == 800){
      MENU_BACK(MSG_EIGHT_HUNDRED_ML);
      MENU_ITEM(function, MSG_IE_ONE_TO_ONE, lcd_one_to_one);
      MENU_ITEM(function, MSG_IE_ONE_TO_TWO, lcd_one_to_two); 
    } else if (covid_volume == 850){
      MENU_BACK(MSG_EIGHT_FIFTY_ML);
      MENU_ITEM(function, MSG_IE_ONE_TO_ONE, lcd_one_to_one);
      MENU_ITEM(function, MSG_IE_ONE_TO_TWO, lcd_one_to_two);     
    } else if (covid_volume == 900){
      MENU_BACK(MSG_NINE_HUNDRED_ML);
      MENU_ITEM(function, MSG_IE_ONE_TO_ONE, lcd_one_to_one);
      MENU_ITEM(function, MSG_IE_ONE_TO_TWO, lcd_one_to_two); 
    } else if (covid_volume == 950){
      MENU_BACK(MSG_NINE_FIFTY_ML);
      MENU_ITEM(function, MSG_IE_ONE_TO_ONE, lcd_one_to_one);
      MENU_ITEM(function, MSG_IE_ONE_TO_TWO, lcd_one_to_two);     
    } else if (covid_volume == 1000){
      MENU_BACK(MSG_ONE_THOUSAND_ML);
      MENU_ITEM(function, MSG_IE_ONE_TO_ONE, lcd_one_to_one);
      MENU_ITEM(function, MSG_IE_ONE_TO_TWO, lcd_one_to_two); 
    }
    END_MENU();
 ...
 void lcd_twenty_four_bpm() {
    ...
    if (covid_volume == 200) {
      ...
      MENU_BACK(MSG_SIX_HUNDRED_ML);
      MENU_ITEM(function, MSG_IE_ONE_TO_ONE, lcd_one_to_one);
      MENU_ITEM(function, MSG_INVALID_COMBO, lcd_invalid_combo);
    }
    END_MENU();
    } 

 void lcd_twenty_eight_bpm() {
    covid_bpm = 28;
    START_MENU();
    if (covid_volume == 200) {
      MENU_BACK(MSG_TWO_HUNDRED_ML);
 ...
 void lcd_two_hundred_ml() {
    covid_volume = 200;
    START_MENU();
    MENU_BACK(MSG_TIDAL_VOLUME);
    MENU_ITEM(submenu, MSG_FOUR_BPM, lcd_four_bpm);
    MENU_ITEM(submenu, MSG_EIGHT_BPM, lcd_eight_bpm);
    MENU_ITEM(submenu, MSG_TWELVE_BPM, lcd_twelve_bpm);
    MENU_ITEM(submenu, MSG_SIXTEEN_BPM, lcd_sixteen_bpm);
    MENU_ITEM(submenu, MSG_TWENTY_BPM, lcd_twenty_bpm);
    MENU_ITEM(submenu, MSG_TWENTY_FOUR_BPM, lcd_twenty_four_bpm);
    MENU_ITEM(submenu, MSG_TWENTY_EIGHT_BPM, lcd_twenty_eight_bpm);
    MENU_ITEM(submenu, MSG_THIRTY_TWO_BPM, lcd_thirty_two_bpm);
    MENU_ITEM(submenu, MSG_THIRTY_SIX_BPM, lcd_thirty_six_bpm);
    END_MENU();
   } 

 void lcd_two_fifty_ml() {
    covid_volume = 250;
    START_MENU();
    MENU_BACK(MSG_TIDAL_VOLUME);
    MENU_ITEM(submenu, MSG_FOUR_BPM, lcd_four_bpm);
 ...
 void lcd_tidal_volume_menu() {
    START_MENU();
    MENU_BACK(MSG_VENTILATOR);
    MENU_ITEM(submenu, MSG_TWO_HUNDRED_ML, lcd_two_hundred_ml);
    MENU_ITEM(submenu, MSG_TWO_FIFTY_ML, lcd_two_fifty_ml);
    MENU_ITEM(submenu, MSG_THREE_HUNDRED_ML, lcd_three_hundred_ml);
    MENU_ITEM(submenu, MSG_THREE_FIFTY_ML, lcd_three_fifty_ml);
    MENU_ITEM(submenu, MSG_FOUR_HUNDRED_ML, lcd_four_hundred_ml);
    MENU_ITEM(submenu, MSG_FOUR_FIFTY_ML, lcd_four_fifty_ml);
    MENU_ITEM(submenu, MSG_FIVE_HUNDRED_ML, lcd_five_hundred_ml);
    MENU_ITEM(submenu, MSG_FIVE_FIFTY_ML, lcd_five_fifty_ml);
    MENU_ITEM(submenu, MSG_SIX_HUNDRED_ML, lcd_six_hundred_ml);
    MENU_ITEM(submenu, MSG_SIX_FIFTY_ML, lcd_six_fifty_ml);
    MENU_ITEM(submenu, MSG_SEVEN_HUNDRED_ML, lcd_seven_hundred_ml);
    MENU_ITEM(submenu, MSG_SEVEN_FIFTY_ML, lcd_seven_fifty_ml);
    MENU_ITEM(submenu, MSG_EIGHT_HUNDRED_ML, lcd_eight_hundred_ml);
    MENU_ITEM(submenu, MSG_EIGHT_FIFTY_ML, lcd_eight_fifty_ml);
    MENU_ITEM(submenu, MSG_NINE_HUNDRED_ML, lcd_nine_hundred_ml);
    MENU_ITEM(submenu, MSG_NINE_FIFTY_ML, lcd_nine_fifty_ml);
    MENU_ITEM(submenu, MSG_ONE_THOUSAND_ML, lcd_one_thousand_ml);
    END_MENU();
 }
     
 void lcd_ventilator_menu() {
  ...
  // INITIALIZATION
  //  
  MENU_ITEM(function, MSG_INITIALIZE_VENTILATOR, lcd_initialize_ventilator);
  //
  // COMPRESSION
  //
  MENU_ITEM(submenu, MSG_TIDAL_VOLUME, lcd_tidal_volume_menu); 
  // HALTING
  //  
  MENU_ITEM(submenu, MSG_HALT_VENTILATOR, lcd_halt_ventilator);  
  //
